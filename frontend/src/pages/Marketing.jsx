...
export default function Marketing() {
  ...
  // If an employee has already "signed in" during this session,
  // skip marketing and go straight to the portal.
  useEffect(() => {
    ...
    <div className="mkt-wrap">
      <header className="mkt-header">
        ...
        <nav className="mkt-nav">
          ...
          {/* Direct link to manufacturing portal */}
          <Link className="mkt-secondary" to="/app" title="Go to manufacturing portal">
            Manufacturing Portal
          </Link>

          {/* Sign-in sends users to /app after login */}
          <Link className="mkt-cta" to="/login?next=/app">
            Sign in
          </Link>
        </nav>
      </header>
      ...
      <section className="mkt-hero">
        ...
        <div className="mkt-hero-actions">
          <Link className="mkt-cta" to="/login?next=/app">Sign in to Portal</Link>
          <Link className="mkt-secondary" to="/app">Open Manufacturing Portal</Link>
      ...
      <footer className="mkt-footer">
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <Link to="/app">Manufacturing Portal</Link>
          <Link to="/login?next=/app">Customer Sign in</Link>
        </div>
      </footer>
    </div>
  );
