  ...
  return (
    <div className="avatar-panel">
        ...
        {!videoError ? (
          ...
          <div className="video-fallback">
            <div className="avatar-content">
              ...
              <div className="avatar-title">AI Avatar</div>
              <div className="avatar-subtitle">Demo guide ready</div>
            </div>
          </div>
        )}
      </div>
      <p className="avatar-description">
        {videoError 
          ? "Interactive demo guide explaining BridgeLineUSA's AI-integrated manufacturing platform."
          : "Click play to hear our AI avatar explain how BridgeLineUSA bridges OEMs and manufacturers with real-time collaboration."
        }
      </p>
    </div>
  );
